CREATE DATABASE  IF NOT EXISTS `library_data_base` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `tb_book` (
  ...
  `book_image` varbinary(55530) DEFAULT NULL,
  `book_genre` varchar(45) DEFAULT NULL,
  `book_acquired_date` date NOT NULL,
  `book_image_name` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id_book`),
...
/*!50001 VIEW `data_of_rents_view` AS select `tb_rent`.`id_rent` AS `id_rent`,`tb_rent`.`rented_date` AS `rented_date`,`tb_rent`.`id_of_book` AS `id_of_book`,`tb_rent`.`id_of_student` AS `id_of_student`,`tb_rent`.`return_date` AS `return_date`,`tb_rent`.`rent_returned` AS `rent_returned`,`tb_rent`.`rent_penality` AS `rent_penality`,`tb_rent`.`rent_observation` AS `rent_observation`,`tb_rent`.`id_of_client` AS `id_of_client`,`tb_book`.`id_book` AS `id_book`,`tb_book`.`book_name` AS `book_name`,`tb_book`.`book_author` AS `book_author`,`tb_book`.`book_publisher` AS `book_publisher`,`tb_book`.`book_stock` AS `book_stock`,`tb_book`.`book_image` AS `book_image`,`tb_book`.`book_genre` AS `book_genre`,`tb_book`.`book_acquired_date` AS `book_acquired_date`,`tb_book`.`book_image_name` AS `book_image_name`,`tb_student`.`id_student` AS `id_student`,`tb_student`.`student_name` AS `student_name`,`tb_student`.`student_registration` AS `student_registration`,`tb_student`.`student_email` AS `student_email`,`tb_student`.`student_phone` AS `student_phone`,`tb_student`.`student_CEP` AS `student_CEP`,`tb_student`.`student_address` AS `student_address`,`tb_student`.`student_module` AS `student_module`,`tb_student`.`student_grade` AS `student_grade`,`tb_student`.`student_course` AS `student_course`,`tb_student`.`student_school` AS `student_school`,`tb_student`.`student_shift` AS `student_shift`,`tb_student`.`student_login` AS `student_login`,`tb_student`.`student_password` AS `student_password`,`tb_student`.`student_image_perfil` AS `student_image_perfil`,`tb_student`.`student_image_name` AS `student_image_name`,`tb_client`.`client_name` AS `client_name`,`tb_client`.`client_CEP` AS `client_CEP`,`tb_client`.`client_address` AS `client_address`,`tb_client`.`client_phone` AS `client_phone`,`tb_client`.`cliente_login` AS `cliente_login`,`tb_client`.`client_password` AS `client_password`,`tb_client`.`client_image_perfil` AS `client_image_perfil`,`tb_client`.`client_email` AS `client_email`,`tb_client`.`id_client` AS `id_client` from (((`tb_rent` left join `tb_book` on((`tb_book`.`id_book` = `tb_rent`.`id_of_book`))) left join `tb_student` on((`tb_student`.`id_student` = `tb_rent`.`id_of_student`))) left join `tb_client` on((`tb_client`.`id_client` = `tb_rent`.`id_of_client`))) union select `tb_rent`.`id_rent` AS `id_rent`,`tb_rent`.`rented_date` AS `rented_date`,`tb_rent`.`id_of_book` AS `id_of_book`,`tb_rent`.`id_of_student` AS `id_of_student`,`tb_rent`.`return_date` AS `return_date`,`tb_rent`.`rent_returned` AS `rent_returned`,`tb_rent`.`rent_penality` AS `rent_penality`,`tb_rent`.`rent_observation` AS `rent_observation`,`tb_rent`.`id_of_client` AS `id_of_client`,`tb_book`.`id_book` AS `id_book`,`tb_book`.`book_name` AS `book_name`,`tb_book`.`book_author` AS `book_author`,`tb_book`.`book_publisher` AS `book_publisher`,`tb_book`.`book_stock` AS `book_stock`,`tb_book`.`book_image` AS `book_image`,`tb_book`.`book_genre` AS `book_genre`,`tb_book`.`book_acquired_date` AS `book_acquired_date`,`tb_book`.`book_image_name` AS `book_image_name`,`tb_student`.`id_student` AS `id_student`,`tb_student`.`student_name` AS `student_name`,`tb_student`.`student_registration` AS `student_registration`,`tb_student`.`student_email` AS `student_email`,`tb_student`.`student_phone` AS `student_phone`,`tb_student`.`student_CEP` AS `student_CEP`,`tb_student`.`student_address` AS `student_address`,`tb_student`.`student_module` AS `student_module`,`tb_student`.`student_grade` AS `student_grade`,`tb_student`.`student_course` AS `student_course`,`tb_student`.`student_school` AS `student_school`,`tb_student`.`student_shift` AS `student_shift`,`tb_student`.`student_login` AS `student_login`,`tb_student`.`student_password` AS `student_password`,`tb_student`.`student_image_perfil` AS `student_image_perfil`,`tb_student`.`student_image_name` AS `student_image_name`,`tb_client`.`client_name` AS `client_name`,`tb_client`.`client_CEP` AS `client_CEP`,`tb_client`.`client_address` AS `client_address`,`tb_client`.`client_phone` AS `client_phone`,`tb_client`.`cliente_login` AS `cliente_login`,`tb_client`.`client_password` AS `client_password`,`tb_client`.`client_image_perfil` AS `client_image_perfil`,`tb_client`.`client_email` AS `client_email`,`tb_client`.`id_client` AS `id_client` from (`tb_client` left join (`tb_student` left join (`tb_book` left join `tb_rent` on((`tb_book`.`id_book` = `tb_rent`.`id_of_book`))) on((`tb_student`.`id_student` = `tb_rent`.`id_of_student`))) on((`tb_client`.`id_client` = `tb_rent`.`id_of_client`))) */;
...
-- Dump completed on 2020-06-17 17:28:10
