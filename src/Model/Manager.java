...
public class Manager {
    ...
    public Manager(Long id, String name, String login, String password, int accessLevel, ImageFile perfilImage, String email, String address, String CEP, String phone, String school) {
        this.id = id;
        this.name = name;
        this.login = login;
    ...
    public Manager(String name, String login, String password, int accessLevel, ImageFile perfilImage, String email, String address, String CEP, String phone, String school) {
        this.name = name;
        this.login = login;
        this.password = password;
        this.accessLevel = accessLevel;
